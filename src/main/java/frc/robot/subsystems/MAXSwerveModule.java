...
public class MAXSwerveModule {
    ...
    public MAXSwerveModule(int drivingCANId, int turningCANId, int cancoderId, double chassisAngularOffset) {
        ...
        // Resets the value of the angle encoder to the value of the cancoder upon
        // initialization
        resetToAbsolute();

        // Initializes the desiredState angle as a new Rotation2d based on the current
    ...
    private void configEncoders() {
        ...
        // Officially gives a reference to the driving encoder object and sets it's
        // position to 0
    ...
    public void resetToAbsolute() {
        // Sets the angle encoder to a position based on the current position of the
        // Cancoder (in radians) and the angular offset
    ...
    // Called every time the position or speed of the wheels need to be updated.
    // Essential for drive
    public void setDesiredState(SwerveModuleState desiredState) {
        ...
        // Creates a new corrected and optimized desired state based off of the original
        // argument and outputs it
        ...
        // Methods are called to apply the desired state to the angular and drive
        // sparkmaxes
    ...
    private void setAngle(SwerveModuleState desiredState) {
        // Code to stop the angular motor if the input given is very small (Eliminates
    ...
    private void setSpeed(SwerveModuleState desiredState, boolean isOpenLoop) {
        // If our system is openLoop (which it is), it will set the motor to a certain
        // percent output based on factors like the max speed and the desired state
        // output
        if (isOpenLoop) {
