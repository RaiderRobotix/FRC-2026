...
public class Vision extends SubsystemBase {
    ...
    // Periodically updates the result, the target list, the yaw, and the pitch, and
    // outputs information to smartDashboard
    @Override
    ...
    // Returns the distance from the pitch value using a lot of trignometry [very
    // hard work :(]
    public double getDistanceFromPitchVal() {
        SmartDashboard.putNumber("Distance?", (51.0 - 12.0) / Math.tan((Math.PI * (pitchval + 30)) / 180));
