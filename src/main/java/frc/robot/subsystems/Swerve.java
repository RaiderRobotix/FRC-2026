...
public class Swerve extends SubsystemBase {
    ...
    // Creates an odometry object (Estimation of our position based on motion data
    // from our gyro)
    ...
    // This periodic method updates the pose and odometry of the robot and outputs
    // signifigant values to smartDashboard
    @Override
    ...
    public Rotation2d getYaw() {
        return (Constants.invertGyro) ? Rotation2d.fromDegrees(360 - m_gyro.getFusedHeading())
    ...
    // Commands the swerve drive to set its modules to specific states based on
    // arguments usually passed from TeleopSwerve.java
